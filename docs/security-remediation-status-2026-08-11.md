...
| SEC-13 back-upweerbaarheid | gedeeltelijk opgelost | de eerste versleutelde productieback-up is met gecontroleerde checksum, omvang en COMPLIANCE-retentie naar Scaleway Parijs Multi-AZ geüpload; geweigerde verwijdering en herstel met uitsluitend de aparte restorecredential ontbreken nog |
| SEC-14 auditlogging/detectie | gedeeltelijk opgelost | duurzaam auditregister, automatische kernregels, incidentregister, statusdegradatie en incidentproef zijn op staging geaccepteerd; externe beschermde opslag en alerts blijven open |
