...
| SEC-13 back-upweerbaarheid | gedeeltelijk opgelost | versleutelde herstelbundels en periodieke taak werken; de provider-onafhankelijke Scaleway-upload met verplichte COMPLIANCE-controle is lokaal geïmplementeerd, maar echte upload- en herstelacceptatie ontbreken nog |
